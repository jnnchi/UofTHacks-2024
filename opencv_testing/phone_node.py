...
class ImageProcessor(Node):
    def __init__(self):
        super().__init__('phone_node')
        self.data_publisher = self.create_publisher(Float32MultiArray, 'processed_data', 10)
        self.br = CvBridge()
    ...
    def capture_and_process_image(self, url):
        ...
        array_msg.data = board.board_layout
        self.data_publisher.publish(array_msg)
        self.get_logger().info(f'Published processed data {board.board_layout}')
